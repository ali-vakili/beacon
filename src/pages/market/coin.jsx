...
class Coin extends Component {
        ...
        <div className="coin-change change-1h item">
          <div className="change">
            <div className="change-badge positive-badge">
              <span className="polygon positive">
        ...
        <div className="coin-change change-24h item">
          <div className="change">
            <div className="change-badge negative-badge">
              <span className="polygon negative">
                <span className="sr-only">Polygon</span>
              </span>
              <h5>1.1%</h5>
            </div>
  ...
  formatPrice = (price) => {
    ...
    const correctPrice = decimal
      ? `${formttedPrice}.${formattedDecimal}`
      : formttedPrice;
  ...
  getBageClasses = (number) => {
    ...
    classes +=
      sign === 1 ? "positive-badge" : sign === -1 ? "negative-badge" : "zero";
    return classes;
  };
